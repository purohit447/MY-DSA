...
int main()
{
    ...
    // Deque data structure: 
    deque<int> de;      //  initiating deque;

    de.push_front(1);  //  front_push 1; 
    de.push_back(2);   //  back_push 2;
    de.push_front(0);  //  front_push 0;
    de.push_back(3);   //  back_push 3;
    ...
    de.pop_back();   //  pop_back();
    de.pop_front();  //  pop_front();

    cout<<de.size()<<endl;  //  read size()         output : 3
